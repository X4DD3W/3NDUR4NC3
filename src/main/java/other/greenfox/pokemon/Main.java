package other.greenfox.pokemon;
...
public class Main {
  public static void main(String[] args) {
    ...
    // Every other.greenfox.pokemon has a name and a type.
    // Certain types are effective against others, e.g. water is effective against fire.

    // Ash has a few other.greenfox.pokemon.
    // A wild other.greenfox.pokemon appeared!

    Pokemon wildPokemon = new Pokemon("Oddish", "leaf", "water");

    // Which other.greenfox.pokemon should Ash use?
